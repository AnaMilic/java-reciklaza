 ...
 * @author Ana
 */
public class TabelaClanDetalji extends AbstractTableModel{

    private final String [] kolone={"ZAKON","BROJ CLANA","NAPOMENA"};
    private List<Clan> listaClanova;
    
    public TabelaClanDetalji(List<Clan> listaClanova) {
